...
import { placeAutoComplete, placeHospitalDetails, placeSearchHospital } from "../services/places.service";
...
async function placeSearchHospitalDetailsController(req: Request, res: Response) {
